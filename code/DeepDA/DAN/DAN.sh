#!/usr/bin/env bash
GPU_ID=0
data_dir=C:/Users/admin/Desktop/MPhil/transferlearning/data/office31
# data_dir=C:\Users\admin\Desktop\MPhil\transferlearning\data\office31
# Navigate up one directory to where main.py is located
cd code/DeepDA/
# Office31
